...
const collectionInfo = {
    name: "Calculadora para construção civil",
    date: "",
    socialMedia: {
        discord: "#",
        twitter: "#",
...
const customStrings = {
    ...
    dateString: "Calculadora para construção civil.", // Date string (ex "Pre sale available {date}") - You can use {date} to insert the collection date
}
